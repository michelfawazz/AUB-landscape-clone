...
module.exports.addPlant = (req, res) => {
    let newPlant = new plant({
        ...
        landscape: [{name: "French name", content: req.body.landc1, group: "general"},{name: "Pronounciation", content: req.body.landc2, group: "general"},{name: "Type", content: req.body.landc3.toLowerCase(), group: "general"},{name: "Uses", content: req.body.landc4, group: "general"},{name: "Growth Rate", content: req.body.landc5, group: "Size/Shape"},{name: "Tree Shape", content: req.body.landc6, group: "Size/Shape"},{name: "Cannopy Symmetry", content: req.body.landc7, group: "Size/Shape"},{name: "Plant Density", content: req.body.landc8, group: "Size/Shape"},{name: "Plant Height", content: req.body.landc9, group: "Size/Shape"},{name: "Plant Spread", content: req.body.landc10, group: "Size/Shape"},{name: "Time to Ultimate Height", content: req.body.landc11, group: "Size/Shape"}],
